/** OS 图标：默认皮肤静态文件位于 /os-icons/ 目录，不要在主题内打包。 */
...
// 与 CF-Server-Monitor 内置 osIcon.js 保持一致的关键词映射
...
export function findOSConfig(osString: string): OSConfig {
